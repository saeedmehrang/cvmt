...
def verify_model_perf(params: Union[EasyDict, Dict], split: str = 'val') -> None:
    ...
    med_mre, perc_25_mre, perc_75_mre = np.median(radial_errors), np.percentile(radial_errors, 25), np.percentile(radial_errors, 75)
...
def plot_histogram(
    ...
    n, bins, _ = ax.hist(array, num_bins, density=False,)
