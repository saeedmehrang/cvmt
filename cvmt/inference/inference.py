...
def compute_c34_features_secondary(
    ...
    return {
        ...
        "vr": vr,
        "hr": hr,
        "ant_pos_ratio": ant_pos_ratio,
        "sup_inf_ratio": sup_inf_ratio,
...
def clasify_by_rules(
    ...
    if not (c2_conc or c3_conc or c4_conc) and c3_t and c4_t:
        ...
        if c3_whr > rect_thresh_max or c4_whr > rect_thresh_max:
            stage = "cs4"
        elif (c3_whr >= rect_thresh_min and c3_whr <= rect_thresh_max) or (
            c4_whr >= rect_thresh_min and c4_whr <= rect_thresh_max
        ):
            stage = "cs5"
...
def predict_image_cmd_interface(
    params: Union[EasyDict, Dict], filepath: str, px2cm_ratio: float
):
