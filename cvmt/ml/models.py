...
class MultiTaskLandmarkUNetCustom(pl.LightningModule):
    ...
    def __init__(
        ...
        self.conv1_2 = OutputTransition(dec_out_chans[4], out_channels1, kernel_size=1,)
        
        # task 2
        self.conv2_1 = DoubleConv(dec_out_chans[3], dec_out_chans[4],)
        self.conv2_2 = OutputTransition(dec_out_chans[4], out_channels2, kernel_size=1,)

        # task 3
        self.conv3_1 = DoubleConv(dec_out_chans[3], dec_out_chans[4],)
        self.conv3_2 = OutputTransition(dec_out_chans[4], out_channels3, kernel_size=1,)
        
        # task 4
        self.conv4_1 = DoubleConv(dec_out_chans[3], dec_out_chans[4],)
        self.conv4_2 = OutputTransition(dec_out_chans[4], out_channels4, kernel_size=1,)
